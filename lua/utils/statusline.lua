...
if O.statusline_color == nil or O.statusline_color:gsub("%s+", "") == "" then
    M.status_color = "nord"
else
    M.status_color = O.statusline_color:gsub("%s+", "")
end

M.properties = {force_inactive = {filetypes = {}, buftypes = {}, bufnames = {}}}

M.properties.force_inactive.filetypes = {
    "NvimTree", "packer", "startify", "toggleterm"
}

M.properties.force_inactive.buftypes = {"terminal"}
