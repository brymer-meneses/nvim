    ...
    components = {
        ...
        left = {
            active = {
                {
                    ...
                    icon = " +",
                    hl = {fg = "cyan", bg = "dark", style = "bold"}
                }, {
                    provider = "git_diff_changed",
                    icon = " ~",
                    hl = {fg = "yellow", bg = "dark", style = "bold"}
                }, {
                    provider = "git_diff_removed",
                    icon = " -",
                    hl = {fg = "red", bg = "dark", style = "bold"},
                    right_sep = function()
            ...
            inactive = {
                {
                    provider = "file_type",
                    hl = {bg = "back", fg = "bg", style = "bold"},
                    left_sep = {str = " ", hl = {bg = "back"}},
                    right_sep = {
                        {str = " ", hl = {bg = "back", fg = "NONE"}},
                        u.icons.slant_right
                    }
                }
            }
        ...
        right = {
            active = {
                ...
                }, u.spaces_component_slant, u.position_component_slant, {
                ...
                {
                    provider = "scroll_bar",
                    hl = {bg = "back", fg = "yellow", style = "bold"}
                }
            },
            inactive = {u.position_component_slant}
        }
    },
