    ...
    components = {
            ...
            active = {
                {
                    ...
                    icon = " +",
                    hl = {fg = "cyan", bg = "fore", style = "bold"}
                }, {
                    provider = "git_diff_changed",
                    icon = " ~",
                    hl = {fg = "yellow", bg = "fore", style = "bold"}
                }, {
                    provider = "git_diff_removed",
                    icon = " -",
                    hl = {fg = "red", bg = "fore", style = "bold"},
                    right_sep = " "
                }
            },
            inactive = {
        ...
        right = {
            active = {
                ...
                }, u.spaces_component_classic, u.position_component_classic, {
            ...
            inactive = {u.position_component_classic}
        }
    },
