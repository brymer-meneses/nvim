    ...
    components = {
        left = {
            active = {
                {
                    ...
                    provider = function()
                        ...
                        return string.format(" %s %s:%s ", u.icons.line_number,
                                             line, col)
                    end,
                    hl = {style = "bold"}
                },
                {provider = "git_branch", icon = "  ", hl = {fg = "cyan"}},
            ...
            inactive = {
                ...
                {provider = "file_type", hl = {fg = "magenta", style = "bold"}},
                {
                    provider = function()
                        local line = vim.fn.line(".")
                        local col = vim.fn.col(".")
            ...
            active = {
                {
                    ...
                    provider = function()
                        local spaces = vim.api.nvim_buf_get_option(0,
                                                                   "shiftwidth")
                    ...
                    provider = function()
                        ...
                        return string.format("%s %s", u.icons.mathematical_L,
                                             total)
                    end,
                    hl = function()
                        local val = {}
